    ...
    >
      ...
      <ng-container
        *ngComponentOutlet="
          ...
          "
      />
      } @else { @switch (node.markType) { @case ('strong') {
      ...
      <ng-container
        *ngTemplateOutlet="unknownSpanTypeTmpl(); context: { $implicit: node }"
      />
      } } }
    </ng-template>
    ...
    >
      ...
      <ng-container
        *ngTemplateOutlet="
        ...
        "
      />
      } @else { @for (child of node.children; track child._key; let index =
      $index) {
      <ng-container
        *ngTemplateOutlet="
          renderNode;
