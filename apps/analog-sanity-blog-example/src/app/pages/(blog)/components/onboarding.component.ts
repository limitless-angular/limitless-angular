  ...
  template: `
    <div class="grid grid-flow-row gap-6 py-60 text-center">
      ...
      >
        ...
        <path
          opacity="0.5"
          d="M195.715 200.816C172.923 186.007 161.527 165.183 161.527 136.954C180.672 111.503 213.493 96 253.835 96C323.35 96 363.692 133.252 373.721 185.776H310.359C303.293 165.183 285.971 148.986 254.291 148.986C220.330 148.986 197.311 169.116 195.715 200.816Z"
          fill="white"
        />
      </svg>
      <div>
        <h3 class="text-sm font-semibold text-gray-900">No posts</h3>
      ...
      <div>
        <a
          ...
          [routerLink]="['/studio/intent/create/template=post;type=post/']"
          [attr.target]="target()"
        >
          <svg
